...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        $query = "SELECT orderid,id,total,time FROM orders WHERE user='$user'";
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 mb-30">
                            ...
                            <div class="widget mb-30">
                                <h3 class="widget-title">Welcome <?php echo $user; ?></h3>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td><a href="" class="btn btn-primary">Support</a></td>
                                              </tr>
                                              <?php
            } 
        }
