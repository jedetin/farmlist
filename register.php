                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                            <form method="post" action="register.php">
                                ...
                                <p>
                                    Already a member? <a href="login.php" class="btn btn-secondary btn-block">Sign in</a>
                                </p>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="footer-wrapper ml-80 mb-30">
                            ...
                            <div class="footer-link">
                                <ul>
                                    ...
                                    <li><a href="shop/index.html">Search by Item</a></li>
                                    <li><a href="vendor/index.html">Search by Vendor</a></li>
