            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="list-group-item d-flex justify-content-between bg-info">
                        ...
                        <ul class="list-group mb-3" id="matchKey">
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                <div>
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 101, name: 'Onion', price: <?php echo $row['101'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 102, name: 'Tomato', price: <?php echo $row['102'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 103, name: 'potato', price: <?php echo $row['103'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 104, name: 'cabbage', price: <?php echo $row['104'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                <div>
                                    <h6 class="my-0">cauliflower (500g)</h6>
                                    <p class="card-title pricing-card-title">₹
                                        <?php echo $row['105'] ?>
                                    </p>
                                </div>
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 105, name: 'cauliflower', price: <?php echo $row['105'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 106, name: 'spinach', price: <?php echo $row['106'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                <div>
                                    <h6 class="my-0">coriander (500g)</h6>
                                    <p class="card-title pricing-card-title">₹
                                        <?php echo $row['107'] ?>
                                    </p>
                                </div>
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 107, name: 'coriander', price: <?php echo $row['107'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 108, name: 'okra', price: <?php echo $row['108'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 109, name: 'ginger', price: <?php echo $row['109'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 110, name: 'chilli', price: <?php echo $row['110'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                ...
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 111, name: 'garlic', price: <?php echo $row['111'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed" id="subjectName">
                                <div>
                                    <h6 class="my-0">Cucumber (500g)</h6>
                                    <p class="card-title pricing-card-title">₹
                                        <?php echo $row['112'] ?>
                                    </p>
                                </div>
                                <span class="text-muted"><button type="button"
                                        class="btn float-right btn-outline-primary"
                                        onclick="cartLS.add({id: 112, name: 'Cucumber', price: <?php echo $row['112'] ?>})">Add
                                        to Cart</button></span>
                            </li>
                    ...
                    <div class="col-xl-6 col-lg-6 mb-30">
                        <div class="card mb-4 shadow-sm">
                            <div class="card-body">
                                <h2>Cart</h2>
                                <button class="btn float-right btn-outline-warning mr-2"
                                    onClick="cartLS.destroy()">Clear</button>
                            </div>
                            <div class="card-body">
